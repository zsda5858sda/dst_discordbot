...
class Hello(Public):
    ...
    @app_commands.command(name = "help", description = "如何使用此機器人")
    async def help(self, interactoin: discord.Interaction):
        await interactoin.response.send_message("待編輯...")

    @app_commands.command(name = "test", description = "如何使用此機器人")
    async def test(self, interactoin: discord.Interaction):
        await interactoin.response.send_message("test...")
